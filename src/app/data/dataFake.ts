export const dataFake = [
    {
        "id":"1",
        "image":"assets/images/noticia-image-1.jpg",
        "title":"LUZ ALIENÍGENA PODE SER TRAPAÇA DOS HUMANOS",
        "description":"LUZ MISTERIOSA SEMPRE QUE APARECE TEM ALGUM SER HUMANO IDIOTA POR PERTO",
        "text":'Recentemente vimos uma luz que até o momento permanece desconhecido a sua origem. Entretanto, notamos algo bastante peculiar. Sempre que essa tal "luzinha" aparece, há um idiota da espécie dos humanos segurando um tipo de disposivito eletrônico. Fiquem espertos meus amigos, sinto que estamos cada vez mais pertos de desmascarar essa patifaria deles.'
    },
    {
        "id":"2",
        "image":"assets/images/noticia-image-2.jpg",
        "title":"DE ONDE VEM O CLONE QUE SURGE DO NADA E NOS IMITA O TEMPO TODO?",
        "description":"SE DEPARAR COM ESSE CLONE PODE SER UMA EXPERIÊNCIA ASSUSTADORA",
        "text":'A internet chegou ao mundo dos fofinhos, e junto com ela, um dos maiores mistérios que assola até os nossos ancestrais ganhou palco. Por que aparece um clone seu quando você passa na frente desse tal de "espelho"? Reunimos alguns de nossos especialistas e eles chegaram a conclusão que não fazem a menor ideia do que possa ser. Contudo, é correto afirmar que se tem alguma palhaçada no meio, com certeza é culpa dos humanos.'
    },
    {
        "id":"3",
